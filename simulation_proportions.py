...
N_sys = 10000 #number of replicates
...
sigma_IC = 0 #initial condition noise
...
#plot max CI for a proportioning process
CI_max = fns_eval.entropies_max_CI(N_cells,Z)
plt.plot(xx,CI_max*np.ones(xx.shape),'--r')
